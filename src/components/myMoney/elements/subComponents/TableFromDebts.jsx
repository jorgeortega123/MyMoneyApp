...
export default function TableFromDebts(lang) {
  ...
  useEffect(() => {
    const toAcredit = () => {
      ...
      if (context.data.debts.length === 0) {
        setthereAccountsToShow(false);
      }
    ...
    <Container1>
      <div className="">
        ...
        <div className=" relative">
          <table className="w-full text-sm text-left text-gray-500 ">
            ...
            <tbody>
              {debts.map((debtsAccounts) => {
                return (
                  <tr
                    key={debtsAccounts.relationship + "key"}
                  ...
                  >
                    ...
                    <td className="px-2 py-1">
                      {debtsAccounts.mount.toFixed(2)}
                    </td>
                    <td className="px-2 py-1">
                      {debtsAccounts.paid.toFixed(2)}
                    </td>
                    <td className="px-2 py-1">
          ...
          {showMoreDetailDebts === true ? (
            <div id="moreDetails" className="flex-col">
              ...
              <div className="flex pt-2 pb-1  ">
                <p className="pt-1 pb-1 pr-1">
                  {lang.lang.components.debts.inf[0]}
                </p>
                <select
                  name=""
                  id="firstAccount"
          ...
          {showHistoryTable != null && (
            <ShowHistoryDebst nameUser={showHistoryTable} />
          )}
        </div>
      </div>
    </Container1>
