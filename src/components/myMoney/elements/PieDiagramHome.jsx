  ...
  return (
    <Fragment>
      <motion.div
            ...
            >
      <div className="p-2 shadow-md shadow-slate-300 dark:shadow-slate-900 mb-2 flex justify-evenly items-center border rounded-xl bg-slate-100 dark:bg-slate-900 ">
